...
public interface ApplicantRepository extends JpaRepository<Applicant, Long> {
	...
	@Query("FROM Applicant a WHERE a.property.project.projectId=:projectId and a.property.propertyId=:propertyId")
	List<Applicant> getAll(Long projectId,Long propertyId);
